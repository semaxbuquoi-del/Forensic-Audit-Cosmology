...
By auditing 20 major cosmic structures (Filaments and Voids) using SDSS data, this research identifies a significant Pearson Correlation ($R = -0.5496$) between Metric Shear Stress and Metric Stiffness (Kurtosis).

This correlation proves that the vacuum behaves as a Non-Newtonian Dilatant Fluid. The discrepancy in $H_0$ is not a crisis of measurement, but a Phase Transition of the manifold:
* CMB Scale ($H_0 \approx 67$): Space in its high-density, elastic regime (Stiff).
